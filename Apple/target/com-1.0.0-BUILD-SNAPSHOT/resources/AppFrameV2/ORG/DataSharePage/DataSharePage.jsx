<%@ Page Language="C#" Inherits="GTP.Runtime.WebControls.GTPPage" Culture="auto"  ContentType="text/javascript" UICulture="auto" meta:resourcekey="res_1_DataSharePage" %>
<%@ Register Assembly="GTP.Runtime.WebControls" Namespace="GTP.Runtime.WebControls" TagPrefix="gtp" %>

  <gtp:ResourceManager ID="resourceManager" runat="server" PageNamespace="GTP.AppFrameV2.Org" InitScriptMode="Jsx" PageName="DataSharePage" CustomIcons="['toolbar/GTP_accept.png','toolbar/GTP_cancel.png']" >
    <Listeners>
  ...
  <gtp:PageParam ID="pageParam" runat="server" >
    <InputParams>
      ...
      <gtp:InputParam Name="viewType" IsCollection="False" Type="Number" Value="1" />
      <gtp:InputParam Name="dummyVisible" IsCollection="False" Type="Boolean" Value="true" />
      ...
      <gtp:InputParam Name="typeCode" IsCollection="False" Type="String" Value="PM" />
      ...
      <gtp:InputParam Name="deployFrame" IsCollection="False" Type="Boolean" Value="true" />
      <gtp:InputParam Name="deployIsRoot" IsCollection="False" Type="Boolean" Value="true" />
      <gtp:InputParam Name="onlySelectInCondition" IsCollection="False" Type="Boolean" Value="true" />
      <gtp:InputParam Name="ShareType" IsCollection="False" Type="Number" Value="2" />
    </InputParams>
    <OutputParams>
