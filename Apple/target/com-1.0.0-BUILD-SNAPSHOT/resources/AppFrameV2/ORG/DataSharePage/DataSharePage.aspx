<%@ Page Language="C#" Inherits="GTP.Runtime.WebControls.GTPPage" Culture="auto"   UICulture="auto" meta:resourcekey="res_0_DataSharePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <gtp:ResourceManager ID="resourceManager" runat="server" PageName="DataSharePage" PageNamespace="GTP.AppFrameV2.Org" InitScriptMode="Linked" >
      <Inherits>
