<%@ Page Language="C#" Inherits="GTP.Runtime.WebControls.GTPPage" Culture="auto"   UICulture="auto" meta:resourcekey="res_0_ResetDynaBizInfoPage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    ...
    <title>重新发布动态组件</title>
  </head>
  <body>
    <gtp:ResourceManager ID="resourceManager" runat="server" PageName="ResetDynaBizInfoPage" PageNamespace="GTP.AppFrameV2.DynaBizComp" InitScriptMode="Linked" >
      <Inherits>
