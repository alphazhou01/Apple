...
(function () {
    ...
    var _class = Ext.extend(GTP.AppFrameV2.BaseBill.GridBillListPage,
	{
	    //</Top>
	    ...
	    //[Start]
	    _loadDataOnTreeRowSelect: function (config) {
	        ///<summary>树行选时加载数据便于下面重写</summary>
	    ...
	    _initCategoryTree: function () {
	        ...
	        if (CategoryTreeGrid) {
	            ...
	            var modifyLeftTree = Ext.AppFrame.Common.getModuleApfExtend("APE_LeftTreeModify");
	            if (modifyLeftTree != "true") {
	            ...
	            CategoryTreeGrid.on("rowselect", function (item, index, node) {
	                ...
	                _this._loadDataOnTreeRowSelect({ resetpage: true, firstLoad: $G.Page.__fistLoad });
	                //加载后删除此变量
    ...
    GTP.AppFrameV2.BaseBill.CategoryGridBillListPage = _class;
})();
//</Bottom>