    ...
    <div class="am-tab-panel am-active">
          <div class="admin-content-body">
		      <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list " id="controll-panel">
		        ...
		        <!-- <li><a class="am-text-warning" href="#"><span class="am-icon-btn am-icon-briefcase"></span><br>在用证件<br>308</a></li>
		        <li><a class="am-text-danger" href="#"><span class="am-icon-btn am-icon-recycle"></span><br>过期证件<br>80082</a></li>
		        <li><a class="am-text-secondary" href="#"><span class="am-icon-btn am-icon-user-md"></span><br>人员总数<br>3000</a></li> -->
		      </ul>
