      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav" >
            <li><a v-for="info in certificates" class="am-cf" v-bind:href="['http\/\/'+info.ref]"><span class="am-icon-file"></span> {{info.name}}<span class="am-icon-star am-fr am-margin-right admin-icon-yellow "></span></a></li>
          </ul>
        </li>
...
var cert_info = new Vue({
	 el:'#collapse-nav',
	 data:{
		 certificates :[{name:"建筑一级建造师",ref:"www.baidu.com"},
