<%@ Page Language="C#" Inherits="GTP.Runtime.WebControls.GTPPage" Culture="auto"   UICulture="auto" meta:resourcekey="res_0_DynaProjectManagePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    ...
    <title>弹性域方案管理页面</title>
  </head>
  <body>
    <gtp:ResourceManager ID="resourceManager" runat="server" PageName="DynaProjectManagePage" PageNamespace="GTP.AppFrameV2.DynaBizComp" InitScriptMode="Linked" >
      <Inherits>
      ...
      <Includes>
        ...
        <gtp:Include FileName="~/GTP/Services/Coding/Common/JS/GTP.CodingWork.WebResource.js" Mode="Script" />
        <gtp:Include FileName="~/GTP/Services/Coding/Common/JS/Codegjs-all.js" Mode="Script" />
        <gtp:Include FileName="~/GTP/Services/Coding/Common/JS/GTP.Coding.GeneralInput.js" Mode="Script" />
