...
(function () {
	...
	//[Start]
	    _initDataContext: function () {
	        if (!$G.Page._dataSource)
	            $G.Page._dataSource = $G.DataContext.getDataSource("DynaDictPoco");
	...
	//[Start]
	    _loadData: function () {
	        ...
	        $G.dispatcher({
	            action: "QueryDictByFilters",
	            args: [record.data.DictCName, record.data.DictFullCode, record.data.DictRemark],
    ...
    GTP.AppFrameV2.DynaBizComp.DynaDictLookUpPage = _class;
})();
//</Bottom>