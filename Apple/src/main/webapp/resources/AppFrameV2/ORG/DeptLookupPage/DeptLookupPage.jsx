<%@ Page Language="C#" Inherits="GTP.Runtime.WebControls.GTPPage" Culture="auto"  ContentType="text/javascript" UICulture="auto" meta:resourcekey="res_1_DeptLookupPage" %>
<%@ Register Assembly="GTP.Runtime.WebControls" Namespace="GTP.Runtime.WebControls" TagPrefix="gtp" %>

  <gtp:ResourceManager ID="resourceManager" runat="server" PageNamespace="GTP.AppFrameV2.Org" InitScriptMode="Jsx" PageName="DeptLookupPage" CustomIcons="['toolbar/GTP_accept.png','toolbar/GTP_cancel.png']" >
    <Listeners>
  ...
  <gtp:PageParam ID="pageParam" runat="server" >
    <InputParams>
      ...
      <gtp:InputParam Name="flipFullName" IsCollection="False" Type="Boolean" Value="false" />
      <gtp:InputParam Name="title" IsCollection="False" Type="String" Value="选择部门" />
    </InputParams>
    <OutputParams>
